...
var taskInput=document.querySelector(".inpution-new-task__field");//Add a new task.
...
var editTask=function(){
    ...
    var editInput=listItem.querySelector('.task__edit-field');
    var label=listItem.querySelector(".task__task-name");
